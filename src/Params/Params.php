...
use ZendServer\DepH\Params\Exception;
...
class Params implements SharedEventManagerAwareInterface
{
    ...
    /**
     * Array of \ZendServer\DepH\Params\ParamsContainerInterface items
    ...
    private function attachTriggers() {
        ...
        $events->attach(array('ZendServer\DepH\Params\ZendServer'), 'getApplicationBaseDir', array($this, 'stopPropagationIfActionPreStage'));
        $events->attach(array('ZendServer\DepH\Params\ZendServer'), array('getPreviousAppVersion', 'getPreviousApplicationBaseDir'), array($this, 'stopPropagationIfNotUpdate'));
        $events->attach(array('ZendServer\DepH\Params\ZendServer'), '*', array($this, 'checkEnvVariable'));
        $events->attach(array('ZendServer\DepH\Params\Custom'), 'get', array($this, 'checkEnvVariable'));
    }
     ...
     * @throws \ZendServer\DepH\Params\Exception\MissingPropertyException
     */
     ...
     * @param \ZendServer\DepH\Params\ParamsContainerInterface $container
     * @throws \ZendServer\DepH\Params\Exception\InvalidArgumentException
     */
    public function addParamContainer(\ZendServer\DepH\Params\ParamsContainerInterface $container) {
