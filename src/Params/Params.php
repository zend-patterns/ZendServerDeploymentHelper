...
class Params implements SharedEventManagerAwareInterface
{
    ...
    private function attachTriggers()
    {
        ...
        $events->attach(
            array('ZendServer\DepH\Params\ZendServer'),
            'getApplicationBaseDir',
            array($this, 'stopPropagationIfActionPreStage')
        );
        $events->attach(
            array('ZendServer\DepH\Params\ZendServer'),
            array('getPreviousAppVersion', 'getPreviousApplicationBaseDir'),
            array($this, 'stopPropagationIfNotUpdate')
        );
