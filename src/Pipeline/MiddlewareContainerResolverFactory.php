...
/**
 * Class MiddlewareContainerResolverFactory
 * @package ZendServer\DepH\Pipeline
 */
class MiddlewareContainerResolverFactory implements FactoryInterface
{
    ...
    {
        return new MiddlewareContainerResolver($container);
    }
}